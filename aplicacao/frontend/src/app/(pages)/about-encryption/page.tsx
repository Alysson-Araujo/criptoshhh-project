...
export default function AboutEncryption() {
  return (
    <section>
      <Header />
      <ContainerInfo
        title="Cesar Encryption"
        description="Cesar encryption is a type of substitution cipher in which each letter in the plaintext is shifted a certain number of places down or up the alphabet. For example, with a shift of 1, A would be replaced by B, B would become C, and so on."
      />
        <ContainerInfo
